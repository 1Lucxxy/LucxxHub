...
local Tabs = {
    Editor = Window:Tab({ Title = "Editor", Icon = "lucide-pen-tool" }),
    Head = Window:Tab({ Title = "Head & Target", Icon = "lucide-user" }),
    Settings = Window:Tab({ Title = "Settings", Icon = "lucide-save" })
}
...
-- TAB 1: EDITOR
local AccDropdown = Tabs.Editor:Dropdown({
...
Tabs.Editor:Section({ Title = "Transform Settings" })
...
Tabs.Head:Section({ Title = "Target System" })
